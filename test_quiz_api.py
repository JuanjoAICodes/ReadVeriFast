...
def test_quiz_api():
    ...
    try:
        ...
        quiz_data = {
            ...
            'user_answers': [0, 1, 0, 2, 1],  # Sample answers
            'wpm_used': 300,
...
def test_quiz_interface_elements():
    ...
    try:
        ...
        checks = [
            ...
            ('Quiz questions container', 'id="quiz-questions"'),
            ('Quiz navigation', 'quiz-navigation'),
            ('Speed reader section', 'id="speed-reader-section"'),
            ('Quiz data variable', 'window.quizData'),
            ('Article ID variable', 'window.articleId'),
            ('Quiz interface script', 'quiz-interface.js'),
            ('Speed reader script', 'speed-reader.js'),
        ]
