...
def test_complete_user_journey():
    ...
    if response.status_code == 200:
        ...
        # Check for essential elements (HTMX-based)
        checks = [
            ('Speed reader section', 'id="speed-reader-section"'),
            ('HTMX speed reader init', 'hx-get="/en/speed-reader/init/'),
            ('Start Quiz button (HTMX)', 'id="start-quiz-btn"'),
            ('Quiz container placeholder', 'id="quiz-container"'),
        ]
